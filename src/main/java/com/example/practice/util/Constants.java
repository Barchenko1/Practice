...
public class Constants {
    ...
    public static final String CREATE_TYPE_PAGE = "createTypePage";
    public static final String CREATE_AUTHOR_PAGE = "createAuthorPage";
    public static final String CREATE_CUSTOMER_PAGE = "createCustomerPage";
    public static final String CREATE_ITEM_PAGE = "createItemPage";
    ...
    public static final String UPDATE_BOOK_PAGE = "updateBookPage";
    public static final String UPDATE_TYPE_PAGE = "updateTypePage";
    public static final String UPDATE_ITEM_PAGE = "updateItemPage";
    public static final String UPDATE_ORDER_PAGE = "updateOrderPage";
